 ...
 */
[RequireComponent(typeof(InterpolateTransformUpdater))]
public class InterpolateTransform : MonoBehaviour
{
    ...
    public virtual void Update()
    {
        ...
        transform.position = Vector3.Lerp(olderTransform, newestTransform, InterpolationControl.InterpolationFactor);
    }
